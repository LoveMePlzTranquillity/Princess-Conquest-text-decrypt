...
module YEA
  module UTILITY
    ...
    #=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
    STOP_NPC_MOVEMENT_SWITCH    = 3038
    STOP_PLAYER_MOVEMENT_SWITCH = 2569
    STOP_PLAYER_MOVEMENT_SWITCH2 = 2723
    STOP_PLAYER_MOVEMENT_SWITCH3 = 1202
    STOP_PLAYER_MOVEMENT_SWITCH4 = 3038
  end # UTILITY
end # YEA
...
module Switch
  ...
  def self.stop_player_movement2
    return $game_switches[YEA::UTILITY::STOP_PLAYER_MOVEMENT_SWITCH2]
  end 
  def self.stop_player_movement3
    return $game_switches[YEA::UTILITY::STOP_PLAYER_MOVEMENT_SWITCH3]
  end    
  def self.stop_player_movement4
    return $game_switches[YEA::UTILITY::STOP_PLAYER_MOVEMENT_SWITCH4]
  end      
end # Switch
...
class Game_Player < Game_Character
  ...
  def move_by_input
    ...
    return if Switch.stop_player_movement2
    return if Switch.stop_player_movement3
    return if Switch.stop_player_movement4
