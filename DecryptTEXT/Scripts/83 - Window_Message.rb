...
class Window_Message < Window_Base
  ...
  def update_show_fast
    @show_fast = true if Input.trigger?(:C) || WolfPad.trigger?(:X,0) || WolfPad.trigger?(:X,1)
  end
  #--------------------------------------------------------------------------
  ...
  def input_pause
    self.pause = true
    wait(10)
    Fiber.yield until Input.trigger?(:B) || Input.trigger?(:C) || WolfPad.trigger?(:X,0) || WolfPad.trigger?(:B,0) || WolfPad.trigger?(:X,1) || WolfPad.trigger?(:B,1)
    Input.update
    self.pause = false
  end
  #--------------------------------------------------------------------------
