...
class Scene_File < Scene_MenuBase
  ...
  def update_savefile_selection
    return on_savefile_ok     if Input.trigger?(:C) || WolfPad.trigger?(:X,0) || WolfPad.trigger?(:X,1)
    return on_savefile_cancel if Input.trigger?(:B) || WolfPad.trigger?(:B,0) || WolfPad.trigger?(:B,1)
    update_cursor
  end
  #--------------------------------------------------------------------------
  # * Save File [OK]
