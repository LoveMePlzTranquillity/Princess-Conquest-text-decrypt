...
class Window_ShopNumber < Window_Selectable
  ...
  def update_number
   if !WolfPad.plugged_in?
    ...
    change_number(1)   if Keys.trigger?(:RIGHT) || WolfPad.repeat?(:L_RIGHT,0) or WolfPad.repeat?(:RIGHT,0) or WolfPad.repeat?(:L_RIGHT,1) or WolfPad.repeat?(:RIGHT,1)
    change_number(-1)  if Keys.trigger?(:LEFT) || WolfPad.repeat?(:L_LEFT,0) or WolfPad.repeat?(:LEFT,0) or WolfPad.repeat?(:L_LEFT,1) or WolfPad.repeat?(:LEFT,1)
    change_number(10)  if Keys.trigger?(:UP) || WolfPad.repeat?(:L_UP,0) or WolfPad.repeat?(:UP,0) or WolfPad.repeat?(:L_UP,1) or WolfPad.repeat?(:UP,1)
    change_number(-10) if Keys.trigger?(:DOWN) || WolfPad.repeat?(:L_DOWN,0) or WolfPad.repeat?(:DOWN,0) or WolfPad.repeat?(:L_DOWN,1) or WolfPad.repeat?(:DOWN,1)
    end
  end
  #--------------------------------------------------------------------------
  # * Change Quantity
