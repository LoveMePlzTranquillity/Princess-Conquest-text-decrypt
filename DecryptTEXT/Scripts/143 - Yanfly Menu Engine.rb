...
module YEA
  module MENU
    ...
    #  :status,       # Opens up the status menu. Default menu item.
    #  :formation,    # Lets player manage party. Default menu item.
      :reigns,      # Launches Common Event 1. Common Event Command.
      :levelup,      # Launches Common Event 1. Common Event Command.
      :states,      # Launches Common Event 1. Common Event Command.
      :diaries,      # Launches Common Event 1. Common Event Command.
      :medals,      # Launches Common Event 2. Common Event Command.
      :calendar,      # Launches Common Event 3. Common Event Command.
      :bestiary,      # Launches Common Event 3. Common Event Command.
      :controls,      # Opens up the controls menu.
      :cheats,      # Launches Common Event 3. Common Event Command.
    ...
    # :command => ["Display Name", EnableSwitch, ShowSwitch, Event ID],
      :reigns => [   "Reign Menu",           23,         0,        40],
      :levelup => [   "Level Up",           719,         0,        870],
      :diaries => [   "Diaries",           472,         0,        5],
      :medals => [    "Medals",            0,         0,       933],
      :states => [    "States",            0,         0,       136],
      :calendar => [    "Calendar",            2479,       0,      354],
      :bestiary => [    "Bestiary",            2765,       0,      827],
      :controls => [    "Controls",            0,       0,      240],
      :cheats => [    "Cheats",            0,         23,       420],
    } # Do not remove this.
...
class Window_MenuCommand < Window_Command
  ...
  def make_command_list
   ...
   #     add_command(Vocab::skill,  :skill,  main_commands_enabled)
      ...
      when :formation
        #add_command(Vocab::status, :formation, main_commands_enabled)
...
class Window_Base < Window
  ...
  def draw_actor_simple_status(actor, dx, dy)
    ...
    draw_actor_exp(actor, dx + 284, dy + line_height * 3, dw)
