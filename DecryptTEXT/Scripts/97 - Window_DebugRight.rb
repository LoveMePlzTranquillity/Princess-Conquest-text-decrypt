...
class Window_DebugRight < Window_Selectable
  ...
  def update_switch_mode
    if Input.trigger?(:C) || WolfPad.trigger?(:X,0) || WolfPad.trigger?(:X,1)
      Sound.play_ok
  ...
  def update_variable_mode
    ...
    value += 1 if Input.repeat?(:RIGHT) || WolfPad.repeat?(:L_RIGHT,0) || WolfPad.repeat?(:RIGHT,0) || WolfPad.repeat?(:L_RIGHT,1) || WolfPad.repeat?(:RIGHT,1)
    value -= 1 if Input.repeat?(:LEFT) || WolfPad.repeat?(:L_LEFT,0) || WolfPad.repeat?(:LEFT,0) || WolfPad.repeat?(:L_LEFT,1) || WolfPad.repeat?(:LEFT,1)
