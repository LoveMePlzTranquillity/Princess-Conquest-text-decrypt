...
#-------------------------------------------------------------------------------
  0 => ["UWtear_m",255,0,true], #tears
  1 => ["UWlift_m",200,0,true], #uw lifts
  20 => ["UWgem1_m",180,0,true], #uw gems
  21 => ["UWgem2_m",180,0,true], #uw gems
  22 => ["UWgem3_m",180,0,true], #uw gems
  60 => ["UWgem1_l",180,0,true], #uw gems
  61 => ["UWgem2_l",180,0,true], #uw gems
  62 => ["UWgem3_l",180,0,true], #uw gems  
  23 => ["UWgemL_m",180,0,true], #uw gems
  24 => ["PinkFlame_m",180,0,true], #pink flame
  25 => ["PinkFlame_l",180,0,true], #pink flame
  31 => ["ShadTorch_l",185,0,true], #shad torch
  3 => ["UWspika",255,0,true], #spika
  4 => ["UWspika",155,0,true], #spikaDim
  40 => ["Fire_m",255,0,true], #fire / lantern
  41 => ["Fire_s",225,0,true], #fire / lantern dim
  42 => ["Fire_l",225,0,true], #fireBig
  50 => ["UWplayer_s",205,0,true], #iceligth1
  51 => ["UWplayer_m",205,0,true], #iceligth2
  52 => ["UWplayer_l",225,0,true], #iceligth3
  99 => ["UWtear_m",0,0,true], #tears
...
class Game_Event < Game_Character
  ...
  def draw_light
    ...
    w = @light.w
    h = @light.h
    return if sx > 800 && sy > 608 && sx + w < 0 && sy + h < 0
...
class Spriteset_Map
  ...
  def update_lights
    ...
    $game_map.light_surface.bitmap.fill_rect(0,0,800,608,$game_map.effect_surface.color)
  ...
  def setup_lights
    ...
    $game_map.light_surface.bitmap = Bitmap.new(800,608)
    $game_map.light_surface.bitmap.fill_rect(0,0,800,608,$game_map.effect_surface.color)
